#
#  Be sure to run `pod spec lint MTPopMenu.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "TinySungo"
  # s.authors            = { "TinySungo" => "872732301@qq.com" }
  # s.social_media_url   = "http://twitter.com/TinySungo"
